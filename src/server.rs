...
pub struct GetMrTurnaroundParams {
    ...
    project_id: Option<String>,
    #[schemars(description = "Group path for cross-project stats (e.g., 'mxp/backend')")]
    group_id: Option<String>,
...
pub struct GetCrossInstanceDashboardParams {
    #[schemars(description = "Comma-separated 'instance:group' pairs (e.g., 'maxprotocol:mxp/backend,planetvpn:freevpnplanet/software'). Groups within same instance are batched.")]
    targets: String,
