...
fn test_language_detection() {
    ...
    assert_eq!(detect_language("ansible/inventory/fvp_premium/prem-fvp-bg25"), "Ansible/Inventory");
    assert_eq!(detect_language("ansible/scripts/fvp_premium/xray_node_in"), "Ansible/Inventory");
